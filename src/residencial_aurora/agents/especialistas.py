...
especialista_reservas = Agent(
    ...
    instruction=(
        ...
        " solicitada e aguarde, mesmo que ele diga que ja confirmou. Quando"
        " reservar_area devolver sucesso true, a reserva ja foi concluida:"
        " informe o codigo e nunca diga que ainda falta confirmar. Nunca"
...
especialista_visitantes = Agent(
    ...
    instruction=(
        ...
        " da tool confirmar isso. Quando autorizar_visitante devolver sucesso"
        " true, a autorizacao ja foi concluida: nunca diga que ainda falta"
        " confirmar. Nunca chame autorizar_visitante de novo"
